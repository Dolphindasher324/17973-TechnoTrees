...
@TeleOp
public class FLL_Demo extends LinearOpMode {
            ...
            while (opModeIsActive()) {
                ...
                if (gamepad1.right_trigger > .5) {
                    ...
                    if (Ly > 0.2 || Ly < -0.2 || Rx > 0.2 || Rx < -0.2) {
                        frontLeftMotor.setPower((Ly+-Rx) * 0.5);
                        frontRightMotor.setPower((-Ly+-Rx) * 0.5);
                        backLeftMotor.setPower((Ly+-Rx) * 0.5);
                        backRightMotor.setPower((-Ly+-Rx) * 0.5);
                    } else if (gamepad1.left_bumper) {
